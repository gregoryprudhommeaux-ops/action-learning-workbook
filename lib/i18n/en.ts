export const en: Record<string, string> = {
  ...
  "gov.baselineHours": "Current response (hours)",
  "gov.baselineDays": "Current response (business days)",
  "gov.baselineHelp":
    "Pre-filled with cohort reference values. Adjust to your team's reality — you can change these anytime.",
  "gov.sla": "Target SLA",
  ...
  "gov.chartBeforeAfter":
    "Gray = your current state (before). Blue = your target SLA (after). Edit the fields on the left anytime — the chart updates live.",
  ...
  "chart.baseline": "Current state (before)",
  "chart.target": "Target SLA (after)",
  ...
  "pilot.c1": "Routine change 1",
  "pilot.c2": "Routine change 2",
  "pilot.c3": "Routine change 3",
  "pilot.c1.ph": "Email tagging & SLA protocol",
  "pilot.c2.ph": "Meeting leadership rotation",
  "pilot.c3.ph": "Governance DRI rule",
  ...
  "sum.slaBefore": "Before → after",
  "sum.slaArrow": "{before} → {after}",
  ...
  "pdf.radar.clock": "Time",
  "pdf.radar.voice": "Voice",
  "pdf.radar.message": "Clarity",
  "pdf.radar.power": "Power",
  ...
  "pdf.sla": "Target SLA",
  "pdf.slaBefore": "Before → after",
  "pdf.slaArrowHours": "{before} → {after}",
  "pdf.slaArrowDays": "{before} → {after}",
  ...
  "admin.signinLead":
    "Create a facilitator account with Google, or continue with an account you already made. The Super Admin must approve new accounts before they can open packs.",
  "admin.signup": "Create facilitator account",
  "admin.signupLead":
    "Sign up with Google. The Super Admin must approve your account before you can open submitted packs.",
  "admin.google": "Continue with Google",
  "admin.googleCreate": "Create facilitator account with Google",
  "admin.back": "Back to the workbook",
  "admin.googleFail": "Google sign-in failed.",
  "admin.needAccount": "Need an account?",
