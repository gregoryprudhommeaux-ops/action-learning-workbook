  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="mb-6 flex flex-col gap-4 border-b border-slate-100 pb-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h2 className="text-xl font-bold text-slate-900">
            Cross-cultural diagnostic matrix
          </h2>
          <p className="mt-1 text-xs text-slate-500 sm:text-sm">
            Check every symptom that is live on this project. The radar updates
            as you go.
          </p>
        </div>
        <div className="rounded-lg border border-slate-200 bg-slate-50 p-3 text-center">
          <span className="block text-xs font-medium text-slate-500">
            Diagnostic friction score
          </span>
            ...
            >
              ...
              <div className="mt-3">
                <label className="mb-1 block text-xs font-semibold text-slate-600">
                  Brief real-life project example
                </label>
                <input
                  type="text"
                  ...
                  placeholder={axis.examplePlaceholder}
        ...
        <div className="space-y-6 lg:col-span-5">
          <div className="sticky top-36 rounded-xl border border-slate-200 bg-slate-50 p-4">
            <h3 className="mb-1 text-center text-sm font-bold text-slate-800">
              Live cultural friction radar
            </h3>
            <p className="mb-4 text-center text-xs text-slate-500">
              Calculated from the symptoms you checked
            </p>
      ...
      <div className="mt-8 flex justify-end border-t border-slate-100 pt-4">
        ...
        >
          Proceed to Step 3: SLA & governance →
        </button>
      </div>
    </div>
  );
